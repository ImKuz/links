...
public extension Publisher {
     ...
     */
    func withUnretained<UnretainedObject: AnyObject, Output>(
        _ obj: UnretainedObject,
        resultSelector: @escaping (
            UnretainedObject,
            Self.Output
        ) -> Output) -> Publishers.WithUnretained<UnretainedObject, Self, Output> {
     ...
     */
    func withUnretained<UnretainedObject: AnyObject>(
        _ obj: UnretainedObject
    ) -> Publishers.WithUnretained<UnretainedObject, Self, (UnretainedObject, Output)> {
...
public extension Publishers {
    struct WithUnretained<UnretainedObject: AnyObject, Upstream: Publisher, Output>: Publisher {
        ...
        public init(
            unretainedObject: UnretainedObject,
            upstream: Upstream,
            resultSelector: @escaping (UnretainedObject, Upstream.Output) -> Output
        ) {
...
private extension Publishers.WithUnretained {
    ...
    where Downstream.Input == Output, Downstream.Failure == Failure {
        ...
        init(
            ...
            resultSelector: @escaping (UnretainedObject, Input) -> Output
        ) {
            self.unretainedObject = unretainedObject
